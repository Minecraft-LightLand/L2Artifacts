...
public class FilterTabManager {
	...
	public static final FilterTabToken<DissolveTab> DISSOLVE = new FilterTabToken<>(DissolveTab::new, () -> ArtifactItems.ITEM_STAT[4].get(), LangData.TAB_DISSOLVE.get());
	public static final FilterTabToken<AugmentTab> AUGMENT = new FilterTabToken<>(AugmentTab::new, () -> ArtifactItems.ITEM_BOOST_MAIN[4].get(), LangData.TAB_AUGMENT.get());
	...
	public void init(Consumer<AbstractWidget> adder, FilterTabToken<?> selected) {
		var token_list = token.stack.getItem() == ArtifactItems.FILTER.get() ? LIST_0 : LIST_1;
		list.clear();
