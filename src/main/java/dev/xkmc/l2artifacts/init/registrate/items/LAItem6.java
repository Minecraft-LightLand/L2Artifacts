...
public class LAItem6 {
	...
	public static final SetEffectEntry<AttributeSetEffect> EFF_MAGE_2;
	public static final SetEffectEntry<AttributeSetEffect> EFF_MAGE_4;
	public static final SetEffectEntry<AttributeSetEffect> EFF_PIRATE_2;
	public static final SetEffectEntry<AttributeSetEffect> EFF_PIRATE_4;
	...
	static {

		{
			...
			EFF_MAGE_2 = helper.setEffect("mage_2", () -> new AttributeSetEffect(
					new AttrSetEntry(MAGIC_FACTOR, ADD_VALUE, m2, true)
			)).lang("Magical Strength").register();

			EFF_MAGE_4 = helper.setEffect("mage_4", () -> new AttributeSetEffect(
					new AttrSetEntry(ABSORB, ADD_VALUE, r4, false)
...

		{
			...
			EFF_PIRATE_2 = helper.setEffect("pirate_2", () -> new AttributeSetEffect(
					new AttrSetEntry(EXPLOSION_FACTOR, ADD_VALUE, e2, true)
			)).lang("Pirate Attack!").register();

			EFF_PIRATE_4 = helper.setEffect("pirate_4", () -> new AttributeSetEffect(
					new AttrSetEntry(EXPLOSION_FACTOR, ADD_VALUE, e4, true),
					new AttrSetEntry(MAGIC_FACTOR, ADD_VALUE, m4, true)
